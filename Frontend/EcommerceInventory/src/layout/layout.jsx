...
import { CssBaseline, ThemeProvider, createTheme, AppBar, Toolbar, IconButton, Typography, Drawer, List, ListItem, ListItemText, Collapse, Divider, Box, Hidden, Menu, MenuItem, ListItemIcon } from '@mui/material';
import { Menu as MenuIcon, ExpandLess, ExpandMore, AccountCircle, Settings as SettingsIcon, Notifications as NotificationsIcon, Logout, Home, Code as CodeIcon, Public as PublicIcon, Business as BusinessIcon, AlternateEmail as AlternateEmailIcon, AutoAwesomeTwoTone, Circle, AddCircleOutlineOutlined, DashboardOutlined, ShoppingCartOutlined, StorefrontOutlined, GroupOutlined, InventoryOutlined, Category, ShoppingBasketRounded, ReceiptOutlined, WarehouseOutlined } from '@mui/icons-material';
...
import { expandItem, activateItem,/*  triggerPageChange */ } from '../redux/reducer/sidebardata.js';

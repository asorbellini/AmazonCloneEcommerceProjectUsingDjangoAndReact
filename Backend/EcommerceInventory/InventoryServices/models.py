...
class RackAndShelvesAndFloor(models.Model):
    ...
    added_by_user_id=models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='added_user_id_rack_shelf_floor')
    created_at=models.DateTimeField(auto_now_add=True)
    updated_at=models.DateTimeField(auto_now=True)
...
class Inventory(models.Model):
    ...
    purchase_order_item_inwarded_log_id=models.ForeignKey(PurchaseOrderItemInwardedLog, on_delete=models.CASCADE, blank=True, null=True, related_name='purchase_order_item_inwarded_log_id_inventory')
    ...
    discount_type=models.CharField(max_length=255, choices=[('AMOUNT', 'AMOUNT'), ('PERCENTAGE', 'PERCENTAGE')], default='PERCENTAGE')
    ...
    stock_status=models.CharField(max_length=255, choices=[('IN_STOCK', 'IN_STOCK'),('OUT_OF_STOCK', 'OUT_OF_STOCK'),('DAMAGED', 'DAMAGED'), ('LOST', 'LOST')], default='OUT_OF_STOCK' )
    inwarded_type=models.CharField(max_length=255, choices=[('PURCHASE', 'PURCHASE'), ('RETURN', 'RETURN'), ('REPLACEMENT', 'REPLACEMENT'), ('WARHOUSE TRANSFER', 'WAREHOUSE TRANSFER')], default='PURCHASE')
    additional_details=models.JSONField()
...
class InventoryLog(models.Model):
    ...
    quantity=models.IntegerField()
    status=models.CharField(max_length=255,choices=[('INWARD','INWARD'),('OUTWARD','OUTWARD'),('DAMAGED','DAMAGED'),('LOST','LOST'),('EXPIRED','EXPIRED'),('RETURNED','RETURNED'),('ADJUSTMENT','ADJUSTMENT'),('WAREHOUSE TRANSFER','WAREHOUSE TRANSFER')],default='INWARD')
    additional_details=models.JSONField()

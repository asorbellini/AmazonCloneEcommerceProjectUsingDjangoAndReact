...
class Users(AbstractUser):
    ...
    plan_type=models.CharField(max_length=50,blank=True,default='Free',null=True,choices=(('FREE','FREE'),('BASIC','BASIC'),('STANDARD','STANDARD'),('PREMIUM','PREMIUM'),('ENTERPRICE','ENTERPRICE')))
    added_by_user_id=models.ForeignKey('self',on_delete=models.CASCADE,blank=True,null=True,related_name='added_by_user_id_users')
...
class UserShippingAddres(models.Model):
...
class Modules(models.Model):
    ...
    module_icon=models.CharField(blank=True, null=True, max_length=50)
    is_menu=models.BooleanField(default=True)
    is_active=models.BooleanField(default=True)
    module_url=models.CharField(blank=True, null=True, max_length=50)
...
class UserPermissions(models.Model):
    ...
    module=models.ForeignKey(Modules,on_delete=models.CASCADE, related_name='module_user_permissions')

...
class ProductQuestions(models.Model):
    ...
    question_user_id=models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='question_by_user_id_questions')
...
class ProductReviews(models.Model):
    ...
    review_user_id=models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='review_by_user_id_reviews')
